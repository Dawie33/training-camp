...
import { getPersonalizedWorkout, PersonalizedWorkout } from '../../services/personalized-workouts'
import { api } from '../../services/api'
import { Colors } from '../../constants/colors'

const TYPE_LABELS: Record<string, string> = {
  for_time: 'For Time', amrap: 'AMRAP', emom: 'EMOM', tabata: 'Tabata',
  strength: 'Force', interval: 'Interval', endurance: 'Endurance',
}
const TYPE_COLORS: Record<string, string> = {
  for_time: Colors.orange, amrap: Colors.blue, emom: Colors.violet,
  tabata: '#ec4899', strength: '#f59e0b', interval: Colors.emerald, endurance: '#06b6d4',
}
...
export default function PersonalizedWorkoutDetailScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Workout IA</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
          ...
          <View style={styles.metaRow}>
            ...
            {workout.difficulty ? (
              <View style={styles.metaItem}>
                ...
                <Text style={styles.metaValue} numberOfLines={1}>{workout.difficulty}</Text>
              </View>
            ) : null}
          </View>
        ) : null}
        ...
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity style={styles.logBtn} onPress={() => setLogModal(true)} activeOpacity={0.85}>
            <Ionicons name="checkmark-circle-outline" size={18} color={Colors.emerald} />
            <Text style={styles.logBtnText}>Logger</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  backBtnStandalone: { margin: 16, width: 40, height: 40, alignItems: 'center', justifyContent: 'center' },
  headerTitle: { color: Colors.text, fontSize: 16, fontWeight: '600', flex: 1, textAlign: 'center' },
  content: { padding: 20, paddingBottom: 40 },
  badges: { flexDirection: 'row', gap: 8, marginBottom: 14, flexWrap: 'wrap', alignItems: 'center' },
  badge: { borderRadius: 10, paddingHorizontal: 12, paddingVertical: 5 },
  badgeText: { fontSize: 13, fontWeight: '600' },
  aiBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: `${Colors.orange}15`, borderRadius: 10,
    paddingHorizontal: 10, paddingVertical: 5,
    borderWidth: 1, borderColor: `${Colors.orange}30`,
  },
  aiBadgeText: { color: Colors.orange, fontSize: 11, fontWeight: '700' },
  ...
  logBtnText: { color: Colors.emerald, fontSize: 15, fontWeight: '600' },
