...
export const activitiesApi = {
  /**
   * Récupère la vue unifiée de toutes les activités planifiées (CrossFit + Force)
   */
  ...
  /**
   * Crée une nouvelle activité planifiée (Strength)
   */
  ...
  /**
   * Met à jour une activité planifiée (Strength)
   */
  ...
  /**
   * Supprime une activité planifiée (Force)
   */
