...
const TABS = [
  { label: 'Historique', href: '/musculation' },
  { label: 'Enregistrer', href: '/musculation/log' },
  { label: 'Générer', href: '/musculation/generate' },
]
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="px-6 pt-8 pb-8">
        ...
        <div className="mb-7">
          <h1 className="text-2xl font-bold text-violet-400">Musculation</h1>
        ...
        <div className="flex border-b border-slate-800 mb-6">
          {TABS.map(tab => {
            const isActive = tab.href === '/musculation' ? pathname === '/musculation' : pathname.startsWith(tab.href)
            return (
