...
import { ArrowLeft, Flame, Loader2, Plus } from 'lucide-react'
...
export default function CrossfitSkillsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-4 sm:p-6 lg:p-8 space-y-8">
      {/* Header */}
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-slate-400 mb-6">Commencez par créer un programme de progression</p>
                  ...
                  <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 p-6 cursor-pointer group">
                    ...
                    {program.estimated_weeks && (
                      <p className="text-xs text-slate-500 mt-3">
                        Durée estimée : {program.estimated_weeks} semaines
                      </p>
                    )}
                  </Card>
                </Link>
