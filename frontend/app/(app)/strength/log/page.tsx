    ...
    >
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <motion.div variants={fadeInUp} className="flex items-center gap-3">
          <Link href="/strength" className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-slate-800 transition-colors text-slate-400 hover:text-white">
            <ArrowLeft className="w-5 h-5" />
          </Link>
          <div>
            <h1 className="text-3xl font-bold">
              <span className="bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">Enregistrer une séance</span>
            </h1>
            <p className="text-slate-400 text-sm mt-0.5">Log une séance de force réalisée</p>
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number" min="1" max="300" placeholder="60"
          ...
          <div>
            ...
            <textarea
              rows={3} placeholder="Exercices réalisés, sensations, charges..."
              value={form.notes}
        ...
        <motion.div variants={fadeInUp} className="flex gap-3 pb-20 sm:pb-8">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex-1 py-3.5 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 transition-all disabled:opacity-50"
          >
